...
func TestP2p_Plugin_Open(t *testing.T) {
	...
	p2pConfig := P2pPluginConfig{
		...
		Name:            "test",
		StaticNodes:     []string{"enode://0x49bf39a33057c4f09952245f9ae8db947c32a44d01bc2ec556ef2417c418a3748146bf545c45220ca9320a05fe039b4c9c8a8231151ef2da5e09a6dfd1199312@10.3.58.6:30303?discport=30301"},
	}
	p := NewP2pPlugin()
